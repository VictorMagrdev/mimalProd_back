...
public class PolicyController {
    ...
    @PostMapping
    @PreAuthorize("@customSecurity.hasPermission('POLICY', 'CREATE')")
    ...
    @GetMapping
    @PreAuthorize("@customSecurity.hasPermission('POLICY', 'READ')")
    ...
    @PreAuthorize("@customSecurity.hasPermission('POLICY', 'DELETE')")
