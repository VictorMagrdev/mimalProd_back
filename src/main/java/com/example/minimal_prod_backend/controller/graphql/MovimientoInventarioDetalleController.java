...
public class MovimientoInventarioDetalleController {
    ...
    public MovimientoInventarioDetalleResponse createMovimientoInventarioDetalle(@Argument("input") MovimientoInventarioDetalleRequest movimientoInventarioDetalleInput) {
    ...
    public MovimientoInventarioDetalleResponse updateMovimientoInventarioDetalle(@Argument Long id, @Argument("input") MovimientoInventarioDetalleRequest movimientoInventarioDetalleInput) {
